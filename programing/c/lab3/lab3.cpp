...
Requirements:
todo:
Improve the simple C++ student management program from Lab 2. For this week you need to keep the information of each student's name and score in a class and maintain the list of student objects in a dynamically allocated array using pointer.

*(1) Create the Student Class that stores name and score. Make sure to have constructor and destructor.
...
*(4) Implement a function to display the list of all students and the scores.
*(5) Implement a function to display the best student(s)'s name(s) and their score(s) (there could be more than one student who have the same highest score).
...
![StudentID]_[StudentFullName]_[ClassName]_Lab3.zip
